...
<div class="alert alert-warning" style="border: 1px solid #f0ad4e; padding: 10px; margin-top: 20px; background-color: #fcf8e3;">
  <strong>Important Announcement:</strong>
    The RSS organizing team is aware of the protests taking place in Los Angeles. While we hope the situation will resolve peacefully soon, we also want to reassure the RSS attendees that the protests are not affecting the USC campus, and RSS 2025 will proceed as planned. The safety and well-being of our attendees remains our highest priority and we will continue to monitor the situation and provide timely updates here.
</div>

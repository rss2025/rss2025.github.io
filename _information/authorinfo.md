...
- **Paper/Demo submission:** Make sure your role is “Author”. Enter title, abstract, and authors. Select your subject areas. Your main submission file may now be uploaded. Science/System and Demo paper descriptions must be in the accepted conference style format and must be submitted as a PDF. Submissions may be edited, updated and replaced up to the paper submission deadline.

...
## Process Overview
We will follow a process inspired by [CHI2024](https://chi2024.acm.org/submission-guides/papers-review-process/), which is similar to the RA-L review process. This is a two-stage process with a threshold decision in round 1, where those above the threshold have 3 weeks to revise and resubmit (and rebut any comments as part of author response), followed by an AC meeting to make final decisions on resubmitted papers in round 2.

<img width="90%" src="{{ site.baseurl }}/images/reviewps.png">
...
- **Incorrectly formatted paper**:
    - All submissions must use the template specified in the Call for Submissions page. Any submissions with other templates will be desk rejected.
...
## AC Assignment
For the submissions that are not desk rejected, PCs will assign papers to ACs based on the paper keywords while avoiding conflicts of interest and balancing the load across ACs.

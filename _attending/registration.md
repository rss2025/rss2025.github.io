...
<p>Check-in is between 8 am and 12:30 am the following day, with a 12 pm check-out. If the front desk is unattended (e.g., close to midnight), guests should call the phone number listed in their housing assignment and instructions email. Staff will be onsite to assist with check-in during the window. </p>
